...
for seed in $(seq 0 4); do OPENAI_LOGDIR=/home/ubuntu/RL_baselines/.log/five_seeds/FPUSH_200k-$seed mpirun -np 16 python3 -m baselines.run --alg=her --env=FetchPush-v1 --num_timesteps=200000 --seed=$seed --layers=3; done
...
# PYTHONHUNTER= python3 -m baselines.run --alg=her --env=FetchReach-v1 --num_timesteps=500
# TEST 2
