...
for seed in $(seq 0 5); do OPENAI_LOGDIR=/home/ubuntu/RL_baselines/.log/run_1/layers_3-$seed mpirun -np 16 python3 -m baselines.run --alg=her --env=FetchPush-v1 --num_timesteps=10000 --seed=$seed --layers=3; done
