...
# TEST 2
mpirun -np 19 python3 -m baselines.run --alg=her --env=FetchPickAndPlace-v1  --num_timesteps=1000 --save_path=.policies/her/test2.1/FPAP_1k --log_path=.log/her/test2.1/FPAP_1k
