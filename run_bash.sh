...
for seed in $(seq 4 5); do OPENAI_LOGDIR=/home/ubuntu/RL_baselines/.log/two_seeds/run_2/FPSLIDE_200k-$seed mpirun -np 16 python3 -m baselines.run --alg=her --env=FetchSlide-v1 --num_timesteps=200000 --seed=$seed --layers=3; done
