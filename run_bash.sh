...
for seed in $(seq 5 6); do OPENAI_LOGDIR=/home/ubuntu/RL_baselines/.log/two_seeds/FPUSH_200k/time_hor_40-$seed mpirun -np 16 python3 -m baselines.run --alg=her --env=FetchPush-v1 --num_timesteps=200000 --seed=$seed ; done
